...
class _EditChannelState extends State<EditChannel> {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        constraints:
            BoxConstraints(maxHeight: 600, maxWidth: 400, minWidth: 350),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      SizedBox(
                        child: Text('Name', style: kBodySmall.copyWith(color: kWhite),),
                        width: 80,
                        ),
                      Text(widget.channel.name, style: kBodySmall.copyWith(color: kWhiteSecondary),)
                    ],
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    children: [
                      SizedBox(
                        child: Text('Type', style: kBodySmall.copyWith(color: kWhite),),
                        width: 80,
                        ),
                      Text(widget.channel.getTypeString(), style: kBodySmall.copyWith(color: kWhiteSecondary),)
                    ],
                  ),
                ),
                Padding(
